...
export const PRICING_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Listed amounts are in GBP (or an approximate local equivalent) before any applicable taxes. Your checkout screen shows the final GBP total from the payment provider.',
  },
] as const
