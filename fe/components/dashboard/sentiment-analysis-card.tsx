    ...
    <div className="flex h-full min-h-0 w-full flex-col rounded-xl border border-border bg-card p-4">
      ...
      {sentiment ? (
        <div className="flex flex-1 flex-col items-center justify-between gap-3">
          ...
          {/* Breakdown strip */}
          <div className="flex w-full items-stretch justify-between gap-1 rounded-lg bg-muted/40 px-3 py-2.5">
            <div className="flex flex-1 flex-col items-center gap-0.5">
              <span className="text-xs font-bold tabular-nums text-success">{posPct}%</span>
