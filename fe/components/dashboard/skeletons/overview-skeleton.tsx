        ...
        <div className="flex items-stretch border-b border-border">
          ...
          <div className="flex flex-1 overflow-hidden">
            {[80, 72, 80, 72, 80].map((w, i) => (
              <div
                key={i}
                className="relative flex min-w-[70px] flex-1 flex-col items-center justify-center gap-1.5 border-r border-border px-3 py-3"
              >
  ...
  return (
    <DashCard className="col-span-4 flex h-full min-h-0 flex-col p-3">
      ...
      <div className="grid flex-1 grid-cols-2 gap-2" style={{ gridTemplateRows: "1fr 1fr" }}>
        ...
        {/* Top-right */}
        <div className="flex flex-col justify-between rounded-xl border border-border p-2.5">
  ...
  return (
    <div className="col-span-3 h-full min-h-0">
      <DashCard className="flex h-full flex-col p-4">
        ...
        <div className="flex flex-1 flex-col items-center justify-center rounded-lg border border-border bg-muted/80 p-3">
          ...
          >
            ...
            {/* White center hole */}
            <div
              className="absolute z-10 rounded-full bg-muted/80"
...
function CompetitorsSkeleton() {
  return (
    <DashCard className="col-span-12 overflow-hidden">
      ...
      <div className="border-b border-border bg-gradient-to-br from-primary/[0.03] via-white to-muted/60 px-6 py-3">
      ...
      <div className="grid gap-5 p-5 lg:grid-cols-12">
        ...
        <div className="flex flex-col gap-2.5 lg:col-span-4">
          {/* Rank */}
          <div className="overflow-hidden rounded-xl border border-border p-3.5">
        ...
        <div className="flex flex-col rounded-xl border border-border p-4 lg:col-span-8">
