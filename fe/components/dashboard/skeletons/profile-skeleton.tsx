...
export function ProfileSkeleton() {
  return (
    <div className="space-y-6 px-2 py-2 font-sans">
      ...
      <div className="rounded-sm border border-black/8 bg-white p-6 shadow-sm">
        ...
        <div className="space-y-2">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="flex items-center justify-between rounded-sm border border-black/8 bg-muted/80 px-4 py-3"
            >
      ...
      {/* Danger zone card */}
      <div className="rounded-sm border border-destructive/20 bg-destructive/[0.04] p-6 space-y-3">
