...
import { Copy, Check, Loader2, RefreshCw, AlertCircle, Briefcase } from "@fe/components/icons";
import { getBrandKit, regenerateBrandKit, type BrandKit } from "@fe/lib/api/analyzer";
