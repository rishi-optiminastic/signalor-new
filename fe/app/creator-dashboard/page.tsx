...
function StatusPill({ row }: { row: CommissionRow }) {
  if (row.bucket === "paid") {
    return (
      <span className="rounded-full bg-success/10 px-2 py-0.5 text-[11px] font-semibold text-success dark:bg-success/40 dark:text-success">
        Paid
      </span>
    );
  }
  if (row.bucket === "locked") {
    return (
      <span className="rounded-full bg-info/10 px-2 py-0.5 text-[11px] font-semibold text-info dark:bg-info/40 dark:text-info">
        Locked
      </span>
    );
  }
  return (
    <span className="rounded-full bg-warning/10 px-2 py-0.5 text-[11px] font-semibold text-warning dark:bg-warning/40 dark:text-warning">
      Pending
    </span>
  );
}
