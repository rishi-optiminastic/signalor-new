...
function CopyPill({ value, label }: { value: string; label?: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-md border border-black/12 bg-white px-3 py-1.5 text-xs font-semibold text-foreground hover:bg-muted"
    >
  ...
  return (
    <div className="mx-auto max-w-xl rounded-2xl border border-black/8 bg-white p-8 text-center">
      ...
      <p className="mt-2 text-[13px] text-muted-foreground">
        ...
        <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs">{code}</code>. It may
        have been disabled.
      </p>
      <Link
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <div className="rounded-2xl border border-black/8 bg-white p-6 sm:p-8">
        ...
        <div className="mt-5 rounded-xl border border-black/8 bg-muted/60 p-4">
          <p className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
            Your share link
          </p>
          <div className="mt-1.5 flex flex-wrap items-center gap-2">
            <code className="min-w-0 flex-1 truncate rounded-md border border-black/8 bg-white px-3 py-1.5 font-mono text-xs text-foreground">
              {data.share_url}
            </code>
        ...
        {data.recent_commissions.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
                <tr className="border-b border-black/6 text-left text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
              ...
              <tbody>
                {data.recent_commissions.map((row, i) => (
                  ...
                  >
                    <td className="px-5 py-2.5 text-foreground">{formatDate(row.created_at)}</td>
      ...
      <div className="rounded-xl border border-black/8 bg-muted/60 p-5 text-xs text-muted-foreground">
        <p>
