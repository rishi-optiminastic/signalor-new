...
export default function CreatorsProgramPage() {
  return (
    <LandingMarketingShell>
      ...
      <section className="px-6 py-16 sm:py-20 lg:px-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            ...
            <Link
              href="#how"
              className="inline-flex items-center gap-1.5 rounded-md border border-black/12 bg-white px-5 py-2.5 text-[13px] font-semibold text-foreground hover:bg-muted"
            >
              How it works
            </Link>
          </div>
      ...
      {/* Closing CTA */}
      <section className="px-6 py-16 lg:px-12">
        <div className="mx-auto max-w-3xl rounded-2xl border border-black/8 bg-muted/60 px-6 py-10 text-center sm:px-10">
