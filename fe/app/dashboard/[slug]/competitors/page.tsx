...
} from "@fe/components/analyzer/competitor-table";
...
import { CompetitorsSkeleton } from "@fe/components/dashboard/skeletons";
import { addCompetitor } from "@fe/lib/api/analyzer";
import { useSession } from "@fe/lib/auth-client";
import { identifyUser, track } from "@fe/amplitude";
import { Globe, Loader2, Plus, Search, X } from "@fe/components/icons";
