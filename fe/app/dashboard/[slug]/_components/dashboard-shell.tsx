    ...
    <div className="flex h-screen w-full bg-background font-sans text-foreground overflow-hidden">
      ...
      <aside className="w-[220px] flex-shrink-0 flex flex-col h-full bg-card border-r border-border px-4 py-5">
        ...
        <div className="flex items-center gap-2.5 px-2 mb-8">
          ...
          <span className="text-lg font-semibold tracking-tight text-primary">Signalor</span>
        </div>
        ...
        <div className="bg-primary/5 border border-primary/15 rounded-2xl p-4 mb-4">
          <p className="text-sm font-bold leading-snug text-foreground mb-1">
            Boost Your
            <br />
            AI Visibility
          </p>
          ...
          <button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-semibold py-2 rounded-xl transition-colors">
            Get Signalor Pro
          </button>
        </div>

        {/* Social icons */}
        <div className="flex items-center justify-center gap-3 text-muted-foreground text-[11px] mt-1">
          <span>f</span>
          <span>X</span>
          <span>in</span>
          <span>o</span>
      ...
      <main className="flex-1 h-full overflow-y-auto">
        ...
        {/* <footer className="px-6 py-4 flex items-center justify-between text-[11px] text-muted-foreground border-t border-border">
          ...
          <div className="flex items-center gap-4">
            <a href="/policy" className="hover:text-foreground transition">Privacy Policy</a>
