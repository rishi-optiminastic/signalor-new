...
import { ProjectLimitReached } from "@fe/components/onboarding/project-limit-reached";
import { GithubConnectStep } from "@fe/components/onboarding/github-connect-step";
import { TurnstileWidget } from "@fe/components/onboarding/turnstile-widget";
import { useOnboardingUiStore } from "@fe/lib/stores/onboarding-ui-store";
import { OnboardingStepper } from "@fe/components/auth/onboarding-stepper";
import { config, routes, signalorWpPlugin } from "@fe/lib/config";
import { ONBOARDING_DRAFT_KEY, storePendingAnalysisAfterPayment } from "@fe/lib/internal-nav";
...
export default function CompanyInfoPage() {
  ...
  async function handleLaunch() {
    ...
    try {
      ...
      import("@fe/lib/api/client").then(({ apiClient }) => {
        apiClient
          .post("/email/welcome/", {
            email: session.user.email,
