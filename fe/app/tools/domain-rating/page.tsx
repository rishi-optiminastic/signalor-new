...
function PreviewBacklinkHistory() {
  return (
    <div>
      <p className="text-sm font-semibold text-foreground">Backlink & DR history</p>
...
function PreviewCompetitorBenchmark() {
  return (
    <div>
      <p className="text-sm font-semibold text-foreground">Competitor authority benchmark</p>
      <p className="mt-1 text-xs text-muted-foreground">
