...
const PUBLIC_ROUTES: Route[] = [
  ...
  { path: "/solutions/visibility", changeFrequency: "monthly", priority: 0.7 },
  { path: "/solutions/competitive-lens", changeFrequency: "monthly", priority: 0.7 },
  { path: "/solutions/fix-playbook", changeFrequency: "monthly", priority: 0.7 },
