...
import { ArrowRight, Gift, Link2, Trophy, Users } from "@legacy/components/icons";
import { CornerDiamonds } from "@legacy/components/ui/intersection-diamonds";
    ...
    >
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-20 sm:py-24 lg:grid-cols-12 lg:gap-12 lg:px-12">
          ...
          <ul className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-3">
            {STEPS.map(({ icon: Icon, title, description }) => (
              <li key={title} className="flex flex-col gap-2">
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-black/10 bg-white text-primary shadow-xs">
        ...
        <div className="lg:col-span-5">
          <div className="relative h-full overflow-hidden rounded-none border border-black/10 bg-gradient-to-br from-primary/5 via-white to-primary/10 p-7 shadow-lg">
            {/* halo glow */}
            <div
              aria-hidden
            ...
            <div className="relative">
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex items-baseline justify-between gap-4 border-b border-black/8 pb-4">
                  ...
                  <span className="font-mono text-sm font-semibold text-success">− $5.00</span>
                </div>
                <div className="flex items-baseline justify-between gap-4 border-b border-black/8 pb-4">
