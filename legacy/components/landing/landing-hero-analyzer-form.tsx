...
// import { Globe, ArrowRight, Loader2, ChevronDown } from "@legacy/components/icons";
...
//         <div
//           className={cn(
//             "group flex flex-col overflow-hidden rounded-none border border-black/10 bg-white shadow-sm ring-1 ring-black/3 transition-[box-shadow,border-color] duration-200",
//             "focus-within:border-primary/35 focus-within:shadow-[0_4px_20px_rgba(224,74,61,0.12)] focus-within:ring-primary/10",
...
//               className="min-w-0 flex-1 bg-transparent py-2 text-sm font-medium text-foreground placeholder:text-muted-foreground focus:outline-none"
//               required
//               autoComplete="url"
//               inputMode="url"
//             />
...
//                       type="button"
//                       className={cn(
//                         "flex w-full items-center gap-2 px-3 py-2 text-left text-sm font-medium text-foreground hover:bg-muted",
//                         opt.name === country && "bg-muted",
//                       )}
//                       onClick={() => {
//                         setCountry(opt.name);
//                         setCountryOpen(false);
...
//         <p className="mt-3 text-left text-xs font-medium leading-relaxed text-muted-foreground">
//           No sign-up required · Results in under 60 seconds · Free for any website
//         </p>

//         {error && (
//           <div className="mt-4 flex items-center justify-start gap-2 rounded-md border border-destructive/30 bg-destructive/50 px-4 py-3 text-sm text-destructive">
//             {error}
//           </div>
//         )}
//       </form>
