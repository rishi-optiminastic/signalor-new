...
import { ArrowRight } from "@legacy/components/icons";
...
export function LandingCreatorsProgram() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -left-32 top-0 h-80 w-80 rounded-full bg-info/30 blur-3xl"
      />
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-3xl px-6 py-12 text-center lg:px-8 lg:py-14">
        ...
        <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            ...
            className="inline-flex h-11 items-center rounded-md border border-black/12 bg-white px-5 text-[13px] font-semibold text-foreground transition hover:bg-muted"
          >
            Learn more
          </Link>
        </div>
