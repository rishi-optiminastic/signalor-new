...
export function HeroLiveTicker() {
  ...
  return (
    <div className="inline-flex items-center gap-2.5 rounded-full border border-black/8 bg-white/85 px-3 py-1.5 text-xs shadow-xs backdrop-blur-sm">
      ...
      <span className="relative min-w-[260px] overflow-hidden text-left">
        <AnimatePresence mode="wait">
          ...
          >
            <span className="font-semibold text-foreground">{item.verb}</span>
