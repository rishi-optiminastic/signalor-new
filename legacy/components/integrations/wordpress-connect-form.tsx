...
import { connectWordPress } from "@legacy/lib/api/integrations";
import { signalorWpPlugin } from "@legacy/lib/config";
...
export function WordPressConnectForm({ email, onConnected }: WordPressConnectFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      {isWpcom ? (
        <div className="rounded-md border border-info/30 bg-info/10 p-3 text-sm text-info dark:text-info">
