...
import { BrandBarChart, BRAND_PALETTE, type BarChartDatum } from '@legacy/components/ui/vis-charts'
...
export function PlatformBarChart({ google, reddit, web }: PlatformBarChartProps) {
  ...
  return (
    <div className="border-border bg-card rounded-xl border p-5">
      <p className="text-foreground mb-4 text-sm font-semibold">Platform Comparison</p>
      <BrandBarChart
        data={data}
        height={200}
        yDomain={[0, 100]}
