...
import { CheckCircle2, XCircle, Search, TrendingUp } from '@legacy/components/icons'
import { Card, CardContent, CardHeader, CardTitle } from '@legacy/components/ui/card'
import { HorizontalScoreBar } from '@legacy/components/ui/vis-charts'
import type { GoogleDetails } from '@legacy/lib/api/visibility'
