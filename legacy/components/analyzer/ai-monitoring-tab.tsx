...
import type { PromptTrack, ShareOfVoiceItem, CitationTrendPoint } from "@legacy/lib/api/analyzer";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-border bg-card p-5">
        <h3 className="mb-4 text-sm font-medium text-muted-foreground">Share of Voice</h3>
        {loading ? (
      ...
      {/* Prompt Tracker */}
      <div className="rounded-lg border border-border bg-card p-5">
        <h3 className="mb-4 text-sm font-medium text-muted-foreground">Prompt Tracker</h3>
        <PromptTracker
          slug={slug}
          tracks={tracks}
          onAdded={handleAdded}
      ...
      {tracks.some((t) => t.results.length > 0) && (
        <div className="rounded-lg border border-border bg-card p-5">
          <h3 className="mb-4 text-sm font-medium text-muted-foreground">Sentiment per Engine</h3>
      ...
      {/* Citation Trend */}
      <div className="rounded-lg border border-border bg-card p-5">
        <h3 className="mb-4 text-sm font-medium text-muted-foreground">Citation Rate Over Time</h3>
        {trend.length > 0 ? (
