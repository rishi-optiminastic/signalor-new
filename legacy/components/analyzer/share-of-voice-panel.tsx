...
import type { ShareOfVoiceItem, Engine } from "@legacy/lib/api/analyzer";
import {
  BrandBarChart,
  BrandDonutChart,
  BRAND_PALETTE,
...
export function ShareOfVoicePanel({ data }: ShareOfVoicePanelProps) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-border/70 bg-card shadow-sm dark:shadow-none">
