...
import { AlertTriangle, CheckCircle2, Loader2, Search, XCircle } from "@legacy/components/icons";

import { getSitemapAudit, type SitemapAuditPage } from "@legacy/lib/api/analyzer";
import { inspectGSCUrl, type GSCInspection } from "@legacy/lib/api/integrations";
