...
import { AlertTriangle, CheckCircle2, FileText, Globe, Loader2, Search } from "@legacy/components/icons";

import { useSession } from "@legacy/lib/auth-client";
import { getGSCAuthUrl, getIntegrationStatus } from "@legacy/lib/api/integrations";
