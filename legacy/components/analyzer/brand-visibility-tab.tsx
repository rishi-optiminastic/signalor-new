...
import type { BrandVisibility, ShareOfVoiceItem } from "@legacy/lib/api/analyzer";
import type { GoogleDetails, RedditDetails, WebMentionsDetails } from "@legacy/lib/api/visibility";
import { GoogleDetailsPanel } from "@legacy/components/visibility/google-details-panel";
import { RedditDetailsPanel } from "@legacy/components/visibility/reddit-details-panel";
import { WebMentionsPanel } from "@legacy/components/visibility/web-mentions-panel";
import {
  BrandBarChart,
  BrandDonutChart,
  BRAND_COLOR,
  ...
  type BarChartDatum,
  type DonutDatum,
} from "@legacy/components/ui/vis-charts";
...
function InsightsRow({
  ...
  return (
    <div
      className="overflow-hidden rounded-xl border border-border/60 bg-card shadow-sm dark:shadow-none"
