...
import { Copy, Check, Loader2, RefreshCw, AlertCircle, Briefcase } from "@legacy/components/icons";
import { getBrandKit, regenerateBrandKit, type BrandKit } from "@legacy/lib/api/analyzer";
