...
import { Cloud, Loader2, Radio, Triangle } from "@legacy/components/icons";

import { getAgentLog, type AgentLogResponse } from "@legacy/lib/api/analyzer";
    ...
    <div className="flex items-center justify-between gap-4 rounded-sm border border-border bg-card px-5 py-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled
          className={cn(
            "inline-flex h-8 items-center rounded-md border border-border bg-background px-3 text-xs font-semibold text-muted-foreground",
