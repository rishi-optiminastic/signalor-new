  ...
  return (
    <div className={cn('relative', className)} style={{ width: size, height: size }}>
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-muted-foreground -mt-0.5 text-[10px] font-medium">/100</span>
      </div>
    </div>
  )
})
...
export const HorizontalScoreBar = memo(function HorizontalScoreBar({
  ...
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      <span
        className={cn(
          'text-muted-foreground shrink-0 truncate capitalize',
      ...
      <span
        className={cn(
          'text-foreground w-8 shrink-0 text-right font-mono font-semibold tabular-nums',
