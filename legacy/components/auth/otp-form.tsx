...
import { InputOTP, InputOTPGroup, InputOTPSlot } from "@legacy/components/ui/input-otp";
import { useOnboardingStore } from "@legacy/lib/stores/onboarding-store";
import { authClient } from "@legacy/lib/auth-client";
import { checkOrganizationExists } from "@legacy/lib/api/organizations";
import { setAccountType } from "@legacy/lib/api/account";
