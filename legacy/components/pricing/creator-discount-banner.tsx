...
import { trackPartnerClick } from "@legacy/lib/api/partners";
import { AFFILIATE_KEY, AFFILIATE_EXPIRES_KEY } from "@legacy/components/analytics/affiliate-capture";
...
export function CreatorDiscountBanner() {
  ...
  return (
    <div className="mx-auto mb-6 flex w-full max-w-3xl items-center justify-between gap-3 rounded-full border border-orange-200 bg-orange-50 px-4 py-2 text-xs text-orange-800">
