...
import {
  ...
  ChartTooltipContent,
  type ChartConfig,
} from "@legacy/components/ui/chart";
...
/* Primary coral (#e04a3d = rgb(224,74,61)) at increasing opacity by score */
function scoreColor(score: number): string {
  if (score <= 0) return "rgba(224,74,61,0.18)";
  if (score < 25) return "rgba(224,74,61,0.38)";
  if (score < 50) return "rgba(224,74,61,0.58)";
  if (score < 75) return "rgba(224,74,61,0.78)";
  return "#e04a3d";
}
