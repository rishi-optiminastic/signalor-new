...
import { ChevronDown } from "@legacy/components/icons";
...
export function GeoScoreHistoryCard({ scoreHistory }: { scoreHistory: ScoreHistoryPoint[] }) {
  ...
  return (
    <div className="col-span-5 bg-white rounded-xl p-5 border border-border shadow-sm">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="relative">
          <Button
            ...
            className="h-7 gap-1 border-border/90 bg-card px-2.5 text-[11px] font-medium text-muted-foreground shadow-xs"
          >
      ...
      <div className="h-[120px] relative">
        ...
        {historyPath && (
          <div className="absolute left-0 top-0 h-full flex flex-col justify-between text-[10px] font-medium text-muted-foreground">
            <span>100</span>
            <span>50</span>
            <span>0</span>
          </div>
