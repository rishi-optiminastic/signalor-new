...
import { AccountTypeForm } from '@legacy/components/auth/account-type-form'
import { AuthMethodForm } from '@legacy/components/auth/auth-method-form'
import { CompanyInfoForm } from '@legacy/components/auth/company-info-form'
import { OrgDetailsForm } from '@legacy/components/auth/org-details-form'
import { OtpForm } from '@legacy/components/auth/otp-form'
import {
  CardContent,
  CardDescription,
  CardFooter,
  CardHeader,
  CardTitle,
} from '@legacy/components/ui/card'
import { attributePartner } from '@legacy/lib/api/partners'
import { redeemReferralCode } from '@legacy/lib/api/referrals'
import { useSession } from '@legacy/lib/auth-client'
import { routes } from '@legacy/lib/config'
import { useOnboardingStore, type OnboardingStep } from '@legacy/lib/stores/onboarding-store'
