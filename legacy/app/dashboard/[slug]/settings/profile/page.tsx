...
import { terminateAccount, cancelTermination, deleteAccount } from "@legacy/lib/api/payments";
import { getProfile, updateProfile, type ProfileData } from "@legacy/lib/api/profile";
import { authClient, signOut } from "@legacy/lib/auth-client";
import { routes } from "@legacy/lib/config";
import { DashboardSettingsNav } from "@legacy/components/settings/dashboard-settings-nav";
import { AnalysisHistoryCard } from "@legacy/components/dashboard/analysis-history-card";
...
import {
  ...
  BTN_OUTLINE,
  BTN_DANGER,
} from "@legacy/components/settings/settings-card";
