...
import { Search } from "@legacy/components/icons";
  ...
  return (
    <div className="flex min-w-0 shrink-0 items-center gap-1.5 sm:gap-2">
      <Button
        ...
        className="hidden h-9 w-52 shrink-0 justify-start gap-2 border-border/90 bg-card px-3 text-[13px] font-normal text-muted-foreground shadow-sm hover:bg-accent md:inline-flex"
      >
      ...
      <Button
        ...
        size="icon"
        onClick={onOpenSearch}
        className="size-9 shrink-0 border-border/90 bg-card shadow-sm md:hidden"
