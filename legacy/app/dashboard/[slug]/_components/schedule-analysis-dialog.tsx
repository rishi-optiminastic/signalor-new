...
import { Calendar as CalendarIcon, Clock, Loader2, X } from "@legacy/components/icons";
...
import { Calendar } from "@legacy/components/ui/calendar";
import { Button } from "@legacy/components/ui/button";
import { cn } from "@legacy/lib/utils";
import { toggleSchedule, type ScheduleFrequency } from "@legacy/lib/api/analyzer";
import { z } from "zod";
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    variant="outline"
                    className={cn(
                      "h-9 w-full justify-start gap-2 border-border/80 bg-white px-3 text-left text-sm font-normal shadow-sm hover:bg-muted",
