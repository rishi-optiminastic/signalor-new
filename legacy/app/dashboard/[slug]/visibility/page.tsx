...
import { getShareOfVoice, type ShareOfVoiceItem } from "@legacy/lib/api/analyzer";
import {
  getGAAuthUrl,
  getGSCAuthUrl,
  getIntegrationStatus,
  type IntegrationInfo,
} from "@legacy/lib/api/integrations";
import { useRun } from "../_components/run-context";
import { BrandVisibilityTab } from "@legacy/components/analyzer/brand-visibility-tab";
import { GAPropertySelector } from "@legacy/components/integrations/ga-property-selector";
import { GATrafficTab } from "@legacy/components/integrations/ga-traffic-tab";
import { GSCSiteSelector } from "@legacy/components/integrations/gsc-site-selector";
import { GSCPerformanceTab } from "@legacy/components/integrations/gsc-performance-tab";
import { AlertCircle, BarChart3, Loader2, CheckCircle2, Search } from "@legacy/components/icons";
import { VisibilitySkeleton } from "@legacy/components/dashboard/skeletons";
