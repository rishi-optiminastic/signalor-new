...
import { addPromptTrack } from "@legacy/lib/api/analyzer";
import { useRun } from "../../_components/run-context";
import { useSession } from "@legacy/lib/auth-client";
import { apiClient } from "@legacy/lib/api/client";
import { getGAData, getIntegrationStatus, type GADataSnapshot } from "@legacy/lib/api/integrations";
import { Lightbulb, Loader2, AlertCircle, Plus, Copy, Check, Search } from "@legacy/components/icons";
  ...
  const tierStyle =
    idea.tier === "high"
      ...
      : idea.tier === "medium"
        ...
        : "border-border/60 bg-muted text-muted-foreground dark:bg-foreground dark:text-muted-foreground";
