...
import { useSession, signOut } from "@legacy/lib/auth-client";
import { checkOrganizationExists } from "@legacy/lib/api/organizations";
import { setAccountType } from "@legacy/lib/api/account";
import { isWorkEmail } from "@legacy/lib/work-email";
import { SIGNUP_DETAILS_KEY } from "@legacy/lib/stores/onboarding-store";
