...
} from "@legacy/components/creator/creator-form-fields";
import { updateMyCreatorProfile } from "@legacy/lib/api/partners-program";
import type { AudienceSize, PayoutMethod, SocialEntry } from "@legacy/lib/api/partners-program";
import { Check, Loader2, Save } from "@legacy/components/icons";
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {error && (
          <div className="rounded-md border border-destructive/30 bg-destructive/10 px-3 py-2 text-xs text-destructive dark:border-destructive/40 dark:bg-destructive/30 dark:text-destructive">
            {error}
          </div>
        )}
        ...
        <div className="sticky bottom-0 flex flex-wrap items-center justify-end gap-3 border-t border-border bg-background/80 py-4 backdrop-blur">
          {savedAt ? (
            <p className="inline-flex items-center gap-1.5 text-xs font-medium text-success dark:text-success">
