...
import { COUNTRIES, flagEmoji } from "@legacy/lib/countries";
import {
  ArrowLeft,
  ArrowRight,
  Check,
          ...
          <div className="border-b border-black/6 px-3 py-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded border border-black/8 bg-white py-1.5 pl-7 pr-2 text-xs focus:outline-none"
              />
            </div>
          </div>
            ...
            <button
              ...
              className={cn(
                ...
                on
                  ...
                  : "border-black/12 bg-white text-muted-foreground hover:border-border",
              )}
            >
...
function ApplyForm({
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <Input
            ...
            value={lockedEmail}
            disabled
            className="h-10 cursor-not-allowed border-black/12 bg-muted text-[13px] text-muted-foreground"
          />
        </div>
      </div>
      ...
      <div className="mt-6 rounded-xl border border-black/8 bg-muted/50 p-4">
        ...
        <div className="mt-3">
          ...
          <textarea
            ...
            className="w-full resize-y rounded-md border border-black/12 bg-white px-3 py-2 text-[13px] leading-relaxed text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-orange-400/40"
          />
      ...
      <Button
        type="submit"
        disabled={submitting}
        className="mt-6 h-11 w-full gap-2 bg-foreground text-sm font-semibold text-background hover:opacity-90"
      >
        {submitting ? (
...
function CopyButton({ value, label }: { value: string; label?: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1 rounded-md border border-black/12 bg-white px-2.5 py-1.5 text-[11px] font-semibold text-foreground hover:bg-muted"
    >
...
function SuccessCard({ result }: { result: CreatorApplyResponse }) {
  return (
    <div className="mx-auto w-full max-w-2xl rounded-2xl border border-success/30 bg-success/40 p-6 shadow-md sm:p-8">
      ...
      <div className="mt-5 space-y-3">
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            <code className="rounded-md border border-black/10 bg-white px-3 py-1.5 font-mono text-sm font-semibold text-foreground">
              {result.code}
            </code>
        ...
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            <code className="min-w-0 flex-1 truncate rounded-md border border-black/10 bg-white px-3 py-1.5 font-mono text-xs text-foreground">
              {result.share_url}
            </code>
