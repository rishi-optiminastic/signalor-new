...
import { RefreshCw } from "@legacy/components/icons";
...
export default function GlobalError({
  ...
  return (
    <html lang="en" className="light">
      <body className="signalor-body m-0 min-h-screen bg-background font-sans text-[#171717] antialiased">
        <div className="flex min-h-screen flex-col items-center justify-center px-6">
          ...
          <button
            type="button"
            onClick={() => reset()}
            className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-8 py-3 text-sm font-semibold text-white shadow-sm transition hover:opacity-92"
          >
