...
import { ArrowLeft, Home, Search } from "@legacy/components/icons";
import LogoComp from "@legacy/components/LogoComp";

export default function NotFound() {
  return (
    <div className="min-h-screen bg-background font-sans text-foreground antialiased selection:bg-orange-100 selection:text-orange-900">
      {/* ── Background grid ── */}
      ...
      {/* ── Header ── */}
      <header className="absolute left-0 right-0 top-0 z-10 border-b border-black/6 bg-background/80 backdrop-blur-md">
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 pb-24 pt-32 text-center">
        ...
        {/* 404 badge */}
        <p className="mb-4 mt-4 font-mono text-xs font-bold uppercase tracking-[0.28em] text-foreground/55">
          404 - Page Not Found
        </p>
