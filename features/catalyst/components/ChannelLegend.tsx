  ...
  return (
    <>
      <div className="my-3.5 flex h-2 gap-1">
        <span className="rounded-sm" style={{ flex: 5, background: BRAND }} />
        <span className="rounded-sm" style={{ flex: 4, background: BLUE }} />
        <span className="rounded-sm" style={{ flex: 2, background: PURPLE }} />
      </div>
