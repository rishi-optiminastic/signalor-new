...
// graphic fades toward the edges. The two Live integrations (Shopify,
// WordPress) sit closest to the centre.
type OrbitNode = {
  name: string
  src: string
  tier: 1 | 2 | 3 | 4
      ...
      <div className="mx-auto max-w-7xl px-6 pt-6 pb-12 lg:px-12 lg:pt-8 lg:pb-14">
        ...
        <div className="mx-auto mt-4 max-w-4xl text-center">
          ...
          <h2
            ...
            className="text-foreground mt-4 text-2xl font-bold tracking-tight whitespace-nowrap sm:text-4xl lg:text-[2.65rem]"
          >
            Works where your{' '}
...
function OrbitIcon({ node }: { node: OrbitNode }): JSX.Element {
